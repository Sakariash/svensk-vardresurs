...
<section class="Main">
    ...
    <div class="Form">
        ...
        <div class="selectForm">
            ...
            <!-- Dropdown menu where user select which hospital is represented. The data is then sent to myFunction() -->
            <Form action="/php/index.php" method="GET">
                ...
                <!-- Dropdown menu where user select which occupation is wanted. The data is then sent to myFunction() -->
                ...
                <!-- Dropdown menu where user select minimum experience. The data is then sent to myFunction() -->
